...
public class GunItemDispatcher {
    ...
    private static final AzCommand FIRE_COMMAND = AzCommand.create("base_controller", "fire", AzPlayBehaviors.HOLD_ON_LAST_FRAME);
    private static final AzCommand AIM_FIRE_COMMAND = AzCommand.create("base_controller", "aim_fire", AzPlayBehaviors.HOLD_ON_LAST_FRAME);
    private static final AzCommand RELOAD_COMMAND = AzCommand.create("base_controller", "reload", AzPlayBehaviors.HOLD_ON_LAST_FRAME);
